...
insert into blogs(user_id, blog_date, blog_text) values (1, date ('2018-01-10'), 'Lorem ipsum');
insert into blogs(user_id, blog_date, blog_text) values (2, date ('2018-05-01'), 'More text here');
insert into blogs(user_id, blog_date, blog_text) values (2, date ('2018-05-02'), 'Lorem ipsum text here');
